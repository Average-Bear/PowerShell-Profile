...
Version 1.6:
	- Added ability to enter only number portion of property numbers to RDP and Ghost.
		(i.e. RDP 123456 or RDP ServerWKPN123456; Ghost 123456 or Ghost ServerWKPN123456)
...
$Stamp = (Get-Date -Format G) + ":"
    ...
    Switch ($CheckBox.IsChecked) {
    	...
    	$true { 
            ...
            $chkProcess | Export-Csv $DocPath -NoTypeInformation -Force 
        }

    	default { 
    
            $chkProcess | Out-GridView -Title "Processes"
        }
    }
...
.NOTES
    Author: JBear   
    Follow instructions and prompts to completetion.
#>
...
function CallNewUserGUI {
    ...
    #>
        ...
        $Info = $(
	        ...
	        "Account Created: " + $(Get-Date).ToShortDateString() + " " + $Date.ToShortTimeString() + " - " +  [Environment]::UserName
        )
